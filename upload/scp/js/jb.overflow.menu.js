...
(function ($, undefined) {
  $.widget("jb.overflowmenu", {
    ...
    _create: function () {
      ...
      this.secondaryMenuContainer
        .children("a")
        .bind("click.overflowmenu", function (e) {
          self.toggle();
        });
      ...
      this.secondaryMenuContainer
        .find("i.icon-sort-down")
        .remove("i.icon-sort-down");
    },
    ...
    refresh: function () {
      ...
      var vHeight = this.primaryMenuHeight,
        hWidth = this.secondaryMenuContainer
      ...
      itemsToHide = this._getItems().filter(function () {
        var $this = $(this),
    ...
    _setOption: function (key, value) {
      ...
      if (key == "refreshOn" && value) {
        ...
        this.options.refreshOn = $(value).bind(
          "resize.overflowmenu",
          function () {
            self.refresh();
          },
