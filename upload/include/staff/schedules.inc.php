<form action="schedules.php" method="POST" name="schedules">
    ...
    <table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
        ...
        <tbody>
            <?php foreach (
                Schedule::objects()->order_by('name')
                ...
                <tr>
                    ...
                    <td data-label="Name"><a href="?id=<?php echo $schedule->getId(); ?>"><?php echo
                    ...
                    <td data-label="Type"><?php echo Format::htmlchars($schedule->getTypeDesc()); ?></td>
                    <td data-label="Created"><?php echo Format::date($schedule->getCreated()); ?></td>
                    <td data-label="Last Updated"><?php echo Format::datetime($schedule->getUpdated()); ?></td>
                </tr>
            <?php }
            ?>
        </tbody>
        <tfoot>
            <tr>
                <td colspan="5">
                    ...
                    <?php } else {
                        echo sprintf(
                            __('No schedules defined yet &mdash; %s add one %s!'),
                            '<a href="schedules.php?a=add">',
                            '</a>'
                        );
                    } ?>
                </td>
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong><?php echo sprintf(
                                        ...
                                        _N('selected schedule', 'selected schedules', 2)
                                    ); ?></strong></font>
