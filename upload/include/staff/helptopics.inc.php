...
">
                            <?php foreach (OsticketConfig::allTopicSortModes() as $i => $m)
                                echo sprintf(
                                    ...
                                    $i,
                                    $i == $cfg->getTopicSortMode() ? ' selected="selected"' : '',
                                    $m
                                ); ?>
                        </select>
                    </div>
        ...
        <tbody class="<?php if ($cfg->getTopicSortMode() == 'm') echo 'sortable-rows'; ?>"
            ...
            ?>
                    <tr id="<?php echo $id; ?>">
                        ...
                        <td data-label="Type"><?php echo $topic->ispublic ? __('Public') : '<b>' . __('Private') . '</b>'; ?></td>
                        <td data-label="Priority"><?php echo $priority; ?></td>
                        <td data-label="Department"><a href="departments.php?id=<?php echo $deptId;
                                                                                ?>"><?php echo $dept; ?></a></td>
                        <td data-label="Last Updated">&nbsp;<?php echo Format::datetime($topic->updated); ?></td>
                        <td data-label="Created">&nbsp;<?php echo Format::datetime($topic->created); ?></td>
                    </tr>
            <?php
                } //end of foreach.
            } ?>
