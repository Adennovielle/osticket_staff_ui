        ...
        <tbody>
            ...
            ?>
                    <tr id="<?php echo $id; ?>">
                        ...
                        <td data-label="Team Name"><a href="teams.php?id=<?php echo $id; ?>"><?php echo
                                                                                                $team->getName(); ?></a> <span>&nbsp;</span> </td>
                        <td data-label="Status">&nbsp;<?php echo $team->isActive() ? __('Active') : '<b>' . __('Disabled') . '</b>'; ?></td>
                        <td data-label="Members" style="text-align:right;padding-right:25px">&nbsp;&nbsp;
                        ...
                        <td data-label="Teams Lead"><a href="staff.php?id=<?php
                                                                            echo $team->getLeadId(); ?>"><?php echo $team->lead ?: ''; ?>&nbsp;</a></td>
                        <td data-label="Created"><?php echo Format::date($team->created); ?>&nbsp;</td>
                        <td data-label="Last Updated"><?php echo Format::datetime($team->updated); ?>&nbsp;</td>
                    </tr>
            <?php
                } //end of foreach
            } ?>
