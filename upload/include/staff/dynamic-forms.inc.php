        ...
        <tbody>
            ...
            foreach (
                ...
                <tr>
                    ...
                    <td data-label="Built-in Forms"><a href="?id=<?php echo $form->get('id'); ?>">
                            <?php echo $form->get('title'); ?></a>
                    <td data-label="Last Updated"><?php echo $form->get('updated'); ?></td>
                </tr>
            <?php } ?>
        </tbody>
        <tbody>
        ...
        <tbody>
            <?php foreach (
                ...
                <tr>
                    ...
                    <td data-label="Built-in Forms"><a href="?id=<?php echo $form->get('id'); ?>"><?php echo $form->get('title'); ?></a></td>
                    <td data-label="Last Updated"><?php echo $form->get('updated'); ?></td>
                </tr>
            <?php }
            ?>
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong><?php echo sprintf(
                                        ...
                                        _N('selected custom form', 'selected custom forms', 2)
                                    ); ?></strong></font>
