                    ...
                    <tr id="<?php echo $id; ?>">
                        ...
                        <td data-label="Name">
                            <a href="departments.php?id=<?php echo $id; ?>"><?php
                                                                            echo Dept::getNameById($id); ?></a><span>&nbsp;</span> <?php echo $default; ?>
                        </td>
                        ...
                        <td data-label="Type"><?php echo $dept->isPublic() ? __('Public') : '<b>' . __('Private') . '</b>'; ?></td>
                        ...
                        <td data-label="Email Address"><span class="ltr"><a href="emails.php?id=<?php echo $emailId; ?>"><?php
                                                                                                                            echo Format::htmlchars($email); ?></a></span></td>
                        <td data-label="Manager"><a href="staff.php?id=<?php echo $dept->manager_id; ?>"><?php
                                                                                                            echo $dept->manager_id ? $dept->manager : ''; ?>&nbsp;</a></td>
                        <td data-label="Created"><?php echo $dept->created; ?></td>
                    </tr>
            <?php
                } //end of foreach.
            } ?>
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="archive-confirm">
        <?php echo sprintf(
            __('Are you sure you want to <b>archive</b> %s?'),
            _N('selected department', 'selected departments', 2)
        ); ?>
    </p>
