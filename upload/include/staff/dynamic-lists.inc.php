<form action="lists.php" method="POST" name="lists">
    ...
    <table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
        ...
        <tbody>
            <?php foreach (
                DynamicList::objects()->order_by('-type', 'name')
                ...
                <tr>
                    ...
                    <td data-label="List Name"><a href="?id=<?php echo $list->getId(); ?>"><?php echo
                                                                                            $list->getPluralName() ?: $list->getName(); ?></a></td>
                    <td data-label="Created"><?php echo $list->get('created'); ?></td>
                    <td data-label="Last Updated"><?php echo $list->get('updated'); ?></td>
                </tr>
            <?php }
            ?>
        </tbody>
        <tfoot>
            <tr>
                <td colspan="4">
                    ...
                    <?php } else {
                        echo sprintf(
                            __('No custom lists defined yet &mdash; %s add one %s!'),
                            '<a href="lists.php?a=add">',
                            '</a>'
                        );
                    } ?>
                </td>
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong><?php echo sprintf(
                                        ...
                                        _N('selected custom list', 'selected custom lists', 2)
                                    ); ?></strong></font>
