        ...
        <tbody>
            ...
            ?>
                    <tr id="<?php echo $row['tpl_id']; ?>">
                        ...
                        <td data-label="Name">&nbsp;<a href="templates.php?tpl_id=<?php echo $row['tpl_id']; ?>"><?php echo Format::htmlchars($row['name']); ?></a>
                            &nbsp;<?php echo $default; ?></td>
                        <td data-label="Status">&nbsp;<?php echo $row['isactive'] ? __('Active') : '<b>' . __('Disabled') . '</b>'; ?></td>
                        <td data-label="Name" In-Use>&nbsp;&nbsp;<?php echo ($inuse) ? '<b>' . __('Yes') . '</b>' : __('No'); ?></td>
                        <td data-label="Date Added">&nbsp;<?php echo Format::date($row['created']); ?></td>
                        <td data-label="Last Updated">&nbsp;<?php echo Format::datetime($row['updated']); ?></td>
                    </tr>
            <?php
                } //end of while.
            endif; ?>
