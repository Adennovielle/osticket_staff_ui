    ...
    <div class="tab_content" id="settings">
        <table class="form_table settings_table" border="0" cellspacing="0" cellpadding="2">
            ...
            <tbody>
                ...
                <tr>
                    <td width="220"><?php echo __('Default Ticket Number Sequence'); ?>:</td>
                ...
                <tr>
                    <td width="220"><?php echo __('Top-Level Ticket Counts'); ?>:</td>
                    <td>
                        ...
                        <select name="default_ticket_queue">
                            ...
                            ?>
                                <option value="<?php echo $cq->id; ?>"
                                    <?php if ($cq->getId() == $config['default_ticket_queue']) echo 'selected="selected"'; ?>><?php echo $cq->getFullName(); ?></option>
                            <?php } ?>
                        </select>
