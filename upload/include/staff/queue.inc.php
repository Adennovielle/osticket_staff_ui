          ...
          <select name="parent_id" id="parent-id">
            ...
            ?>
              <option value="<?php echo $cq->id; ?>"
                <?php if ($cq->getId() == $queue->parent_id) echo 'selected="selected"'; ?>><?php echo $cq->getFullName(); ?></option>
            <?php } ?>
          </select>
        ...
        <select name="filter">
          ...
          ?>
            <option value="<?php echo $path; ?>"
              <?php if ($path == $queue->filter) echo 'selected="selected"'; ?>><?php echo Format::htmlchars($label); ?></option>
          <?php } ?>
        </select>
        <div class="error"><?php
        ...
        <select name="sort_id">
          ...
          <?php foreach ($queue->getSortOptions() as $sort) { ?>
            <option value="<?php echo $sort->id; ?>"
              <?php if ($sort->id == $queue->sort_id) echo 'selected="selected"'; ?>><?php echo Format::htmlchars($sort->getName()); ?></option>
          <?php } ?>
        </select>
        <div class="error"><?php
        ...
        + function() {
          var Q = setInterval(function() {
            ...
            <?php foreach ($queue->getSortOptions() as $C) {
              echo sprintf(
                'addSortOption(%d, {name: %s, default: %d});',
                $C->sort_id,
                JsonDataEncoder::encode($C->getName()),
