            ...
            <tbody>
                ...
                ?>
                    <tr id="<?php echo $page->id; ?>">
                        ...
                        <td data-label="Name">&nbsp;<a href="pages.php?id=<?php echo $page->id; ?>"><?php echo Format::htmlchars($page->getLocalName() ?: $page->getName()); ?></a></td>
                        <td data-label="Type" class="faded"><?php echo $page->type; ?></td>
                        <td data-label="Status">
                            <span> &nbsp;</span> <?php echo $page->isActive() ? __('Active') : '<b>' . __('Disabled') . '</b>'; ?>
                            <span>&nbsp;&nbsp;</span> <?php echo $inuse ? '<em>' . __('(in-use)') . '</em>' : ''; ?>
                        </td>
                        <td data-label="Date Added">&nbsp;<?php echo Format::date($page->created); ?></td>
                        <td data-label="Last Updated">&nbsp;<?php echo Format::datetime($page->updated); ?></td>
                    </tr>
                <?php
                } //end of foreach. 
                ?>
