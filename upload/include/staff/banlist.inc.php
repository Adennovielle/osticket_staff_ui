        ...
        <tbody>
            ...
            ?>
                    <tr id="<?php echo $row['id']; ?>">
                        ...
                        <td data-label="Email Address">&nbsp;<a href="banlist.php?id=<?php echo $row['id']; ?>"><?php echo Format::htmlchars($row['val']); ?></a></td>
                        <td data-label="Ban Status">&nbsp;&nbsp;<?php echo $row['isactive'] ? __('Active') : '<b>' . __('Disabled') . '</b>'; ?></td>
