        ...
        <tbody>
            ...
            ?>
                    ...
                    <tr id="<?php echo $id; ?>">
                        ...
                        <td data-label="Name"><span>&nbsp;</span> <a href="slas.php?id=<?php echo $id;
                                                                                        ?>"><?php echo Format::htmlchars($sla->getName());
                                                                                            ?></a><span>&nbsp;</span> <?php echo $default; ?></>
                        <td data-label="Status"><?php echo $sla->isActive() ? __('Active') : '<b>' . __('Disabled') . '</b>'; ?></td>
                        <td data-label="Grace Period" style="text-align:right;padding-right:35px;"><?php echo $sla->getGracePeriod(); ?> &nbsp;</td>
                        <td data-label="Date Added">&nbsp;<?php echo Format::date($sla->getCreateDate()); ?></td>
                        <td data-label="Last Updated"> &nbsp;<?php echo Format::datetime($sla->getUpdateDate()); ?></td>
                    </tr>
            <?php
                } //end of foreach.
            } ?>
