...
<script>
    if (window.innerWidth <= 900) {
        document.querySelectorAll(".admin-nav .jb-overflowmenu-container ul a").forEach(function(a) {
            a.className = "";
        });
    }
</script>
<nav class="admin-nav jb-overflowmenu"
    id="customQ_nav">
    <ul id="sub_nav" class="<?php echo $info ? '' : 'admin-sub-nav'; ?>">
        <?php
