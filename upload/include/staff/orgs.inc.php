    ...
    <div style="min-height:25px;">
        <form action="orgs.php" method="get">
            ...
            <div class="attached input">
                ...
                <button type="submit" class="attached button" style="height:45px; "><i class="icon-search"></i>
                </button>
        ...
        <tbody>
            ...
            ?>
                <tr id="<?php echo $org['id']; ?>">
                    ...
                    <td data-label="Name">&nbsp; <a href="orgs.php?id=<?php echo $org['id']; ?>"><?php
                                                                                                    echo $org['name']; ?></a> </td>
                    <td data-label="Users">&nbsp;<?php echo $org['user_count']; ?></td>
                    <td data-label="Created"><?php echo Format::date($org['created']); ?></td>
                    <td data-label="Last Updated"><?php echo Format::datetime($org['updated']); ?>&nbsp;</td>
                </tr>
            <?php
            }
            ?>
