    ...
    <tbody>
        ...
        foreach ($agents as $A) { ?>
            <tr id="<?php echo $A->staff_id; ?>">
                <td data-label="Name">&nbsp;<?php echo Format::htmlchars($A->getName()); ?></td>
                <td data-label="Department">&nbsp;<?php echo Format::htmlchars((string) $A->dept); ?></td>
                <td data-label="Email">&nbsp;<?php echo Format::htmlchars($A->email); ?></td>
                <td data-label="Phone Number">&nbsp;<?php echo Format::phone($A->phone); ?></td>
                <td data-label="Extension">&nbsp;<?php echo $A->phone_ext; ?></td>
                <td data-label="Mobile Number">&nbsp;<?php echo Format::phone($A->mobile); ?></td>
            </tr>
        <?php
        } // end of foreach
        ?>
