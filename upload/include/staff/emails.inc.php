        ...
        <tbody>
            ...
            ?>
                    <tr id="<?php echo $id; ?>">
                        ...
                        <td data-label="Email"><span class="ltr no-hiding-span"><a href="emails.php?id=<?php echo $id; ?>"><?php
                                                                                                                            echo Format::htmlchars((string) $email); ?></a></span>
                            <?php echo ($default) ? ' <small>' . __('(Default)') . '</small>' : ''; ?>
                        </td>
                        <td data-label="Priority"><?php echo $email->priority ?: $def_priority; ?></td>
                        <td data-label="Department"><a href="departments.php?id=<?php $email->dept_id ?: $def_dept_id; ?>"><?php
                                                                                                                            echo $email->dept ?: $def_dept_name; ?></a></td>
                        <td data-label="Created">&nbsp;<?php echo Format::date($email->created); ?></td>
                        <td data-label="Last Updated">&nbsp;<?php echo Format::datetime($email->updated); ?></td>
                    </tr>
            <?php
                } //end of while.
            endif; ?>
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong><?php echo sprintf(
                                        ...
                                        _N('selected email', 'selected emails', 2)
                                    ); ?></strong></font>
