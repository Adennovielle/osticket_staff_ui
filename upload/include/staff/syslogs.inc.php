        ...
        <tbody>
            ...
            ?>
                    <tr id="<?php echo $row['log_id']; ?>">
                        ...
                        <td data-label="Log Title">&nbsp;<a class="tip" href="#log/<?php echo $row['log_id']; ?>"><?php echo Format::htmlchars($row['title']); ?></a></td>
                        <td data-label="Log Type"><?php echo $row['log_type']; ?></td>
                        <td data-label="Log Date">&nbsp;<?php echo Format::daydatetime($row['created']); ?></td>
                        <td data-label="IP Address"><?php echo Format::htmlchars($row['ip_address']); ?></td>
                    </tr>
            <?php
                } //end of while.
            endif; ?>
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong><?php echo sprintf(
                                        ...
                                        _N('selected log entry', 'selected log entries', 2)
                                    ); ?></strong></font>
